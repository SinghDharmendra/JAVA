...
public class BinaryTree {
	 ...
	 * Reference)
	 */
	static void diagonalPrintUtil(Node root, int d, HashMap<Integer, Vector<Integer>> passedMap) {
		...
		Vector<Integer> k = passedMap.get(d);
		...
		diagonalPrintUtil(root.left, d + 1, passedMap);

		// Vertical distance remains same for right child
		diagonalPrintUtil(root.right, d, passedMap);
	}
